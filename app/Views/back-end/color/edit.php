    ...
    <div class="section-body">
      ...
      <div class="row mt-sm-4">
        <div class="col-12 col-md-12 col-lg-7">
          <div class="card">
            <form method="post" action="<?= site_url('updatecolor/' . $color->id) ?>" class="needs-validation" novalidate="">
              <?php csrf_field(); ?>
              ...
              <div class="card-body">
                    ...
                    <div class="form-group col-lg-12">
                      ...
                      <select name="product" class="form-control select2" required>
                        ...
                        <?php foreach ($product as $p) { ?>
                          <option <?php if ($color->product_id == $p['id']) {
                ...
                <div class="card-footer text-right">
                  ...
                  <a href="<?= site_url('warna') ?>" class="btn btn-danger">Kembali</a>
                </div>
            </form>
          </div>
        </div>
