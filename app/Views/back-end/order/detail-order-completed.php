      ...
      <div class="invoice">
              ...
              <div class="row">
                <div class="col-md-4">
                  <address>
                    ...
                    <?= date('d-M-Y H:i', strtotime($order->booking_date)) ?><br><br>
                ...
                <div class="col-md-4">
                  <address>
                    ...
                    <?= date('d-M-Y H:i', strtotime($order->delivery_date)) ?><br><br>
                    <strong>Tanggal Diterima:</strong><br>
                    <?= date('d-M-Y H:i', strtotime($order->date_received)) ?><br><br>
                  </address>
                </div>
                <div class="col-md-4 text-md-right">
                  <address>
                    <strong>Jasa Pengiriman:</strong><br>
                    No. Resi: <?= $order->resi ?><br>
        ...
        <div class="text-md-right">
          <div class="float-lg-left mb-lg-0 mb-3">
            <a href="<?= site_url('orderan-dikirim') ?>" class="btn btn-danger btn-icon icon-left"><i class="fas fa-arrow-left"></i> Kembali</a>
          </div>
        </div>
      </div>
    </div>
