                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-lg-12">
                                ...
                                <input type="text" class="form-control" name="name" value="<?= $category->category_name?>" required>
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12">
                                ...
                                <textarea class="form-control" name="desc" required><?= $category->category_desc?></textarea>
                                <div class="invalid-feedback">
